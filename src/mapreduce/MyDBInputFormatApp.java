...
public class MyDBInputFormatApp {
	...
	public static void main(String[] args) throws Exception{
		...
		final Job job = new Job(conf , MyDBInputFormatApp.class.getSimpleName());
	...
	public static class MyMapper extends Mapper<LongWritable, MyUser, Text, NullWritable>{
		protected void map(LongWritable key, MyUser value, org.apache.hadoop.mapreduce.Mapper<LongWritable,MyUser,Text,NullWritable>.Context context)
